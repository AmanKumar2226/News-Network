...
export default function Footer(){
    return(
      ...
      <section className="pb-14 pt-24 flex justify-center items-center bg-gray-100 dark:bg-black">
            ...
            <div className="flex flex-col flex justify-start items-start lg:w-80">
              <div className="xl:flex-col flex justify-start items-center xl:items-start">
                <div className="flex justify-center mr-6 xl:mr-0 dark:text-white text-gray-800">
                  <a href="/home"><img className="logo-white" src="./images/logo-white.jpeg" alt="" /></a>
                </div>
                <div className="flex justify-center flex-col">
                  <div className="xl:mt-8">
                    <p className="text-gray-600 dark:text-gray-300 text-sm leading-normal">Copyright © 2024 NEWS NETWORK INDIA.</p>
                  </div>
                  <div className="mt-2">
              ...
              <div className="grid lg:grid-cols-3 grid-cols-2 gap-y-10 lg:gap-y-0 gap-x-0 lg:gap-x-0">
                <div className="lg:w-40">
                  ...
                  <div className="mt-6 flex justify-start items-start flex-col space-y-2">
                    <div>
                      <a href="javascript:void(0)" className="text-gray-800 dark:text-white focus:outline-none focus:opacity-75 hover:opacity-75 text-sm md:text-base leading-relaxed">About us</a>
                    </div>
                    <div>
                      <a href="javascript:void(0)" className="text-gray-800 dark:text-white focus:outline-none focus:opacity-75 hover:opacity-75 text-sm md:text-base leading-relaxed">Blog</a>
                    </div>
                    <div>
                      <a href="/contact-us" className="text-gray-800 dark:text-white focus:outline-none focus:opacity-75 hover:opacity-75 text-sm md:text-base leading-relaxed">Contact us</a>
                    </div>
                    <div>
                      <a href="javascript:void(0)" className="text-gray-800 dark:text-white focus:outline-none focus:opacity-75 hover:opacity-75 text-sm md:text-base leading-relaxed">Pricing</a>
                    </div>
                    <div>
                      <a href="javascript:void(0)" className="text-gray-800 dark:text-white focus:outline-none focus:opacity-75 hover:opacity-75 text-sm md:text-base leading-relaxed">Testimonials</a>
                    </div>
                  </div>
                </div>
                <div className="lg:w-40">
                  ...
                  <div className="mt-6 flex flex justify-start items-start flex-col space-y-2">
                    <div>
                      <a href="javascript:void(0)" className="text-gray-800 dark:text-white focus:outline-none focus:opacity-75 hover:opacity-75 text-sm md:text-base leading-relaxed">Help center</a>
                    </div>
                    <div>
                      <a href="javascript:void(0)" className="text-gray-800 dark:text-white focus:outline-none focus:opacity-75 hover:opacity-75 text-sm md:text-base leading-relaxed">Terms of service</a>
                    </div>
                    <div>
                      <a href="javascript:void(0)" className="text-gray-800 dark:text-white focus:outline-none focus:opacity-75 hover:opacity-75 text-sm md:text-base leading-relaxed">Legal</a>
                    </div>
                    <div>
                      <a href="javascript:void(0)" className="text-gray-800 dark:text-white focus:outline-none focus:opacity-75 hover:opacity-75 text-sm md:text-base leading-relaxed">Privacy policy</a>
                    </div>
                    <div>
                      <a href="javascript:void(0)" className="text-gray-800 dark:text-white focus:outline-none focus:opacity-75 hover:opacity-75 text-sm md:text-base leading-relaxed">Status</a>
                    </div>
                  </div>
                </div>
